...
SYSTEM_PROMPT_PT_BR: str = (
    ...
    "e oriente avaliacao clinica direta. Se o caso NAO for gestacional/"
    "obstetrico/puerperal, NAO cite diretrizes de pre-natal "
    "(manual_ms_prenatal), gestacao de alto risco (ms_gestacao_alto_risco) "
    "ou parto (ms_parto_normal) como aplicaveis — esses documentos podem "
    "aparecer nos chunks recuperados pelo RAG mas sao irrelevantes pra "
    "pacientes nao gestantes. Cite apenas se a evidencia for genuinamente "
    "transferivel (ex.: trecho sobre saude mental geral que aparece num "
    "manual obstetrico).\n"
