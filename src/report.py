...
SYSTEM_PROMPT_PT_BR: str = (
    ...
    "baixa energia, isso pode indicar quadros sutis como depressao pos-parto, "
    "ansiedade encoberta ou minimizacao de sintomas; destaque essa inconsistencia "
    "como achado clinico. Quando as modalidades CONVERGEM (ex.: paciente "
    "verbaliza angustia e a voz tambem demonstra angustia), nao invente "
    "inconsistencia: declare a coerencia entre os sinais como um achado que "
    "reforca a interpretacao clinica.\n"
